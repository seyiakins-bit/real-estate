...
function BeachHouse2() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://real-estatebackend.onrender.com/api/contact", {
        method: "POST",
      ...
      if (data.success) {
        ...
        const whatsappMessage = encodeURIComponent(
          `Hello, my name is ${formData.name}. I’m interested in Beach House 2. ${formData.message} Contact me at ${formData.phone} or ${formData.email}`
        );
  ...
  // Cloudinary images for BeachHouse2
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 w-full">
      <h1 className="text-3xl font-bold mb-6 text-center">
        Modern Beachfront Villa - Beach House 2
      </h1>
      ...
      <div className="mt-8 bg-white p-6 rounded-xl shadow-md">
        ...
        <p>
          A sophisticated and modern villa located at the heart of Ilashe Beach, Lagos. Designed for comfort, elegance, and panoramic sea views.
        </p>

        <h2 className="font-semibold mt-6 mb-2">Description:</h2>
        <p>
          This 6-bedroom luxury villa features contemporary interiors, state-of-the-art kitchen, private pool, rooftop lounge, and expansive terraces that overlook the ocean.
        </p>

        <h2 className="font-semibold mt-6 mb-2">Amenities include:</h2>
        <p>
          Rooftop Lounge, Infinity Pool, Home Cinema, Gym, 24/7 Security, Smart Home Controls, Underground Parking, Outdoor Barbecue Area, and Fiber Internet.
        </p>
