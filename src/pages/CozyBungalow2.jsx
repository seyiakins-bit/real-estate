// src/pages/CozyBungalow2.jsx
import React, { useState } from "react";
import { Carousel } from "react-responsive-carousel";
import "react-responsive-carousel/lib/styles/carousel.min.css";

function CozyBungalow2() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 w-full">
      <h1 className="text-3xl font-bold mb-6 text-center">
        Quiet Residential Bungalow with Garden – Surulere, Lagos
      </h1>
      ...
      <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} interval={4000}>
        {[
          ...
          <div key={idx}>
            <img src={img} alt={`Bungalow view ${idx + 1}`} className="w-full h-80 object-cover" />
          </div>
        ))}
      </Carousel>
      ...
      <div className="mt-8 bg-white p-6 rounded-xl shadow-md">
        ...
        <p>
          A spacious 3-Bedroom bungalow with a private garden in Surulere, Lagos. Ideal for families who love greenery
          and peaceful living while staying close to the city center.
        </p>
        ...
        <div className="mt-6 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-2xl font-semibold text-green-600">₦55,000,000</p>
          <a
      ...
      <div className="w-full mt-8 rounded-lg overflow-hidden shadow-lg">
        <iframe
          ...
          title="Surulere Bungalow Location"
